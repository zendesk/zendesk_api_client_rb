...
# Taken from https://github.com/lostisland/faraday_middleware/blob/master/lib/faraday_middleware/response/follow_redirects.rb
# License is MIT
module ZendeskAPI
  module Middleware
    module Request
      # Public: Exception thrown when the maximum amount of requests is exceeded.
      class RedirectLimitReached < Error::NetworkError
